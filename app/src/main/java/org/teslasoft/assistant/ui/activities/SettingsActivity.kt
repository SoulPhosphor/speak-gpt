...
class SettingsActivity : FragmentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        transition.excludeTarget(R.id.row_voice_browser, true)
        transition.excludeTarget(R.id.row_voice_language, true)
        transition.excludeTarget(R.id.group_voice_input, true)
        ...
        transition2.excludeTarget(R.id.row_voice_browser, true)
        transition2.excludeTarget(R.id.row_voice_language, true)
        transition2.excludeTarget(R.id.group_voice_input, true)
