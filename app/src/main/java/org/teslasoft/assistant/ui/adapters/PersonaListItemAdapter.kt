...
// The chevron is purely decorative - the whole row is the tap target. In
// pick mode (chosen for the chat from Quick Settings) that tap selects the
// Companion (onClick); otherwise it opens the editor.
