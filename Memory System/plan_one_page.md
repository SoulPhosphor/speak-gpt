...
*(Status recorded 2026-07-28. Agents: update this page whenever the state
...
- **No-model mode** — a notice that memories can't enter chats yet, plus
  an analysis mode that writes lore book entries instead.
